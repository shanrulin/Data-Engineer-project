...
, user_id varchar, level varchar, song_id varchar, artist_id varchar, session_id varchar, \
...
# not sure what data type for star_time
time_table_create = ("CREATE TABLE IF NOT EXISTS time (start_time timestamp PRIMARY KEY, hour int, day int, \
week int, month int, year int, weekday int);") #timestamps of records in songplays broken down into specific units
